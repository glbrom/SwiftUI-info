...
/*
 ...
 Фреймворк общего назначения с для роботы с асинхронными потоками данных
 
 Это как серия ивентов, нажатия кнопки как поток не нажатие кнопки, нажатие, не нажатие..
 Обновление интерфейса тоже поток.. все вокруг потоки
